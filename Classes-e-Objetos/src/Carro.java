...
//        this.quantidadePneus = quantidadePneus;       utilizaremos o uoutro modo para que possamos criar varia regras
        /*
         o this.quantidadePneus pega  dav vaiavel la fora e po segungo quantidadePneus pega do construtor declarado na classe*/
    }

    /*
    criaremos uma regra para adicionar + 1 na quantidade de pneus para constar o Estepe do carro tambem
    */
    public Integer getQuantidadePneus() {
        return quantidadePneus + 1;
        /*
        criando essa regra poderemos alterar a quantitade de estepes que irão em cada carro podendo mudar para qualquer valor que quizermos
         */
    }
    ...
    /*
    Para criarmos o getter e o setter tem um atalho
    cliqua com botao direito do mause + generate +getter and setter + ;escolhe os que estao faltando e pronto
     */
    ...
    public void imprimeValores() {
        ...
        /*quantidadePneus = nao utilizaremos essa variavel pois ela mostra quantos pneus o carro poswsui , mas queremos mostra
         tambem a soma total de pneus que o carro tem com o estepe incluido por isso usaremos o getQuantidadePneus */
    }
}
